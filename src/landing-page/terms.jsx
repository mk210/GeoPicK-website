          ...
          <DialogContentText id="alert-dialog-slide-description">
            <ThemeProvider theme={theme}>
              <Typography variant="body1" style={{ fontWeight: "300" }}>
                ...
                or on behalf of an entity (“you”) and GeoPicK (“we,” “us” or
                “our”), concerning your access to and use of our mobile
                application (the “Application”). You agree that by accessing the
                Application, you have read, understood, and agree to be bound by
                all of these Terms and Conditions Use. IF YOU DO NOT AGREE WITH
                ALL OF THESE TERMS AND CONDITIONS, THEN YOU ARE EXPRESSLY
                PROHIBITED FROM USING THE APPLICATION AND YOU MUST DISCONTINUE
                USE IMMEDIATELY. Supplemental terms and conditions or documents
                that may be posted on the Application from time to time are
                ...
                any right to receive specific notice of each such change. It is
                ...
                revised Terms are posted. The information provided on the
                Application is not intended for distribution to or use by any
                ...
                choose to access the Application from other locations do so on
                ...
                Conditions Generator. The Application is intended for users who
                ...
                their parent or guardian to use the Application. If you are a
                minor, you must have your parent or guardian read and agree to
                these Terms of Use prior to you using the Application.
                INTELLECTUAL PROPERTY RIGHTS Unless otherwise indicated, the
                Application is our proprietary property and all source code,
                databases, functionality, software, website designs, audio,
                video, text, photographs, and graphics on the Application
                ...
                property rights and unfair competition laws of the United Arab
                Emirates, foreign jurisdictions, and international conventions.
                The Content and the Marks are provided on the Application “AS
                ...
                are eligible to use the Application, you are granted a limited
                license to access and use the Application and to download or
                ...
                to the Application, Content, and the Marks. USER REPRESENTATIONS
                ...
                under the age of 13; (5) not a minor in the jurisdiction in
                which you reside, or if a minor, you have received parental
                permission to use the Site; (6) you will not access the
                Application through automated or non-human means, whether
                through a bot, script or otherwise; (7) you will not use the
                Application for any illegal or unauthorized purpose; and (8)
                ...
                or future use of the Application(or any portion thereof). USER
                REGISTRATION You may be required to register with the
                Application. You agree to keep your password confidential and
                ...
                PROHIBITED ACTIVITIES You may not access or use the Application
                for any purpose other than that for which we make the
                Application available. The Application may not be used in
                connection with any commercial endeavors except those that are
                specifically endorsed or approved by us. As a user of the
                Application, you agree not to: Systematically retrieve data or
                other content from the Application to create or compile,
                directly or indirectly, a collection, compilation, database, or
                directory without written permission from us. Make any
                unauthorized use of the Application, including collecting
                usernames and/or email addresses of users by electronic or other
                means for the purpose of sending unsolicited email, or creating
                user accounts by automated means or under false pretenses. Use a
                buying agent or purchasing agent to make purchases on the
                Application. Use the Application to advertise or offer to sell
                goods and services. Circumvent, disable, or otherwise interfere
                with security-related features of the Application, including
                ...
                framing of or linking to the Application. Trick, defraud, or
                mislead us and other users, especially in any attempt to learn
                sensitive account information such as user passwords; Make
                improper use of our support services or submit false reports of
                abuse or misconduct. Engage in any automated use of the system,
                ...
                Application. Attempt to impersonate another user or person or
                use the username of another user. Sell or otherwise transfer
                your profile. Use any information obtained from the Application
                in order to harass, abuse, or harm another person. Use the
                ...
                the Application. Harass, annoy, intimidate, or threaten any of
                our employees or agents engaged in providing any portion of the
                Application to you. Delete the copyright or other proprietary
                rights notice from any Content. Copy or adapt the Application’s
                software, including but not limited to Flash, PHP, HTML,
                JavaScript, or other code. Upload or transmit (or attempt to
                ...
                maintenance of the Application. Upload or transmit (or attempt
                ...
                or offline reader that accesses the Application, or using or
                launching any unauthorized script or other software. Disparage,
                tarnish, or otherwise harm, in our opinion, us and/or the
                Application. Use the Application in a manner inconsistent with
                any applicable laws or regulations. USER GENERATED CONTRIBUTIONS
                The Application may invite you to chat, contribute to, or
                participate in blogs, message boards, online forums, play games
                ...
                on the Application, including but not limited to text, writings,
                ...
                of the Application and through third-party websites. As such,
                ...
                Your Contributions do not include images of person(s) Your
                ...
                law or regulation. Any use of the Application in violation of
                ...
                use the Application. CONTRIBUTION LICENSE By posting your
                Contributions to any part of the Application, or making
                Contributions accessible to the Application by linking your
                ...
                Contributions provided by you in any area on the Application.
                You are solely responsible for your Contributions to the
                Application and you expressly agree to exonerate us from any and
                all responsibility and to refrain from any legal action against
                us regarding your Contributions. We have the right, in our sole
                and absolute discretion, (1) to edit, redact, or otherwise
                change any Contributions; (2) to re-categorize any Contributions
                to place them in more appropriate locations on the Application;
                and (3) to pre-screen or delete any Contributions at any time
                and for any reason, without notice. We have no obligation to
                monitor your Contributions. GUIDELINES FOR REVIEWS We may
                provide you areas on the Application to leave reviews or
                ...
                MOBILE APPLICATION LICENSE Use License If you access the
                Application via a mobile application, then we grant you a
                ...
                “App Distributor”) to access the Application: (1) the license
                ...
                beneficiary thereof. SOCIAL MEDIA As part of the functionality
                of the Application, you may link your account with online
                accounts you have with third-party service providers (each such
                account, a “Third-Party Account”) by either: (1) providing your
                Third-Party Account login information through the Application;
                ...
                on and through the Application via your account, including
                ...
                and through your account on the Application. Please note that if
                a Third-Party Account or associated service becomes unavailable
                ...
                longer be available on and through the Application. You will
                have the ability to disable the connection between your account
                on the Application and your Third-Party Accounts at any time.
                ...
                registered to use the Application. You can deactivate the
                connection between the Application and your Third-Party Account
                ...
                picture that become associated with your account. SUBMISSIONS
                ...
                CONTENT The Application may contain (or you may be sent via the
                ...
                Third-Party Websites accessed through the Application or any
                Third-Party Content posted on, available through, or installed
                from the Application, including the content, accuracy,
                ...
                thereof by us. If you decide to leave the Application and access
                the Third-Party Websites or to use or install any Third-Party
                ...
                the Application or relating to any applications you use or
                install from the Application. Any purchases you make through
                ...
                and other information in certain areas of the Application, such
                as sidebar advertisements or banner advertisements. If you are
                an advertiser, you shall take full responsibility for any
                advertisements you place on the Application and any services
                provided on the Application or products sold through those
                advertisements. Further, as an advertiser, you warrant and
                represent that you possess all rights and authority to place
                advertisements on the Application, including, but not limited
                to, intellectual property rights, publicity rights, and
                contractual rights. As an advertiser, you agree that such
                advertisements are subject to our Digital Millennium Copyright
                Act (“DMCA”) Notice and Policy provisions as described below,
                and you understand and agree there will be no refund or other
                compensation for DMCA takedown-related issues. We simply provide
                the space to place such advertisements, and we have no other
                relationship with advertisers. APP MANAGEMENT We reserve the
                right, but not the obligation, to: (1) monitor the Application
                ...
                of the Application. PRIVACY POLICY We care about data privacy
                and security. Please review our Privacy Policy. By using the
                Application, you agree to be bound by our Privacy Policy, which
                is incorporated into these Terms of Use. Please be advised the
                Application is hosted in the United Arab Emirates. If you access
                the Application from the European Union, Americas, or any other
                ...
                transferring your data to the United Arab Emirates, and you
                expressly consent to have your data transferred to and processed
                in the United Arab Emirates. DIGITAL MILLENNIUM COPYRIGHT ACT
                (DMCA) NOTICE AND POLICY Notifications We respect the
                intellectual property rights of others. If you believe that any
                material available on or through the Application infringes upon
                ...
                following information: (1) A physical or electronic signature of
                a person authorized to act on behalf of the owner of an
                exclusive right that is allegedly infringed; (2) identification
                of the copyrighted work claimed to have been infringed, or, if
                multiple copyrighted works on the Application are covered by the
                Notification, a representative list of such works on the
                Application; (3) identification of the material that is claimed
                ...
                allegedly infringed upon. Counter Notification If you believe
                your own copyrighted material has been removed from the
                Application as a result of a mistake or misidentification, you
                ...
                address is outside the United Arab Emirates, for any judicial
                district in which we are located; (3) a statement that you will
                accept service of process from the party that filed the
                ...
                action to restrain you from engaging in infringing activity
                ...
                Agent XYZ Attn: Copyright Agent 1234, ABC Street Dubai
                xyz@abccopyright.com COPYRIGHT INFRINGEMENTS We respect the
                intellectual property rights of others. If you believe that any
                material available on or through the Application infringes upon
                ...
                or linked to by the Application infringes your copyright, you
                should consider first contacting an attorney. TERM AND
                TERMINATION These Terms of Use shall remain in full force and
                effect while you use the Application. WITHOUT LIMITING ANY OTHER
                PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR
                SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO
                AND USE OF THE SITE (INCLUDING BLOCKING CERTAIN IP ADDRESSES),
                ...
                THE SITE OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION
                ...
                the right to change, modify, or remove the contents of the
                Application at any time or for any reason at our sole discretion
                without notice. However, we have no obligation to update any
                information on our Application. We also reserve the right to
                modify or discontinue all or part of the Application without
                ...
                maintenance related to the Application, resulting in
                interruptions, delays, or errors. We reserve the right to
                change, revise, update, suspend, discontinue, or otherwise
                modify the Application at any time or for any reason without
                ...
                to access or use the Application during any downtime or
                discontinuance of the Application. Nothing in these Terms of Use
                will be construed to obligate us to maintain and support the
                Application or to supply any corrections, updates, or releases
                in connection therewith. GOVERNING LAW These Terms of Use and
                your use of the Application are governed by and construed in
                ...
                to its conflict of law principles. DISPUTE RESOLUTION To
                ...
                informally for at least [# of years] days before initiating
                arbitration. Such informal negotiations commence upon written
                notice from one Party to the other Party. Binding Arbitration If
                ...
                costs are determined to by the arbitrator to be excessive, we
                ...
                county] County, [name of state], and the Parties hereby consent
                ...
                commenced more than [# of years] years after the cause of action
                ...
                information on the Application that contains typographical
                errors, inaccuracies, or omissions that may relate to the
                Application, including descriptions, pricing, availability, and
                ...
                information on the Application at any time, without prior
                notice. DISCLAIMER THE APPLICATION IS PROVIDED ON AN AS-IS AND
                AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE APPLICATION
                SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT
                PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR
                IMPLIED, IN CONNECTION WITH THE APPLICATION AND YOUR USE
                ...
                THE ACCURACY OR COMPLETENESS OF THE APPLICATION’S CONTENT OR THE
                CONTENT OF ANY WEBSITES LINKED TO THIS APPLICATION AND WE WILL
                ...
                FROM YOUR ACCESS TO AND USE OF THE APPLICATION, (3) ANY
                ...
                FROM THE APPLICATION, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR
                THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE APPLICATION
                ...
                AMOUNT PAID, IF ANY, BY YOU TO US DURING THE [# of months] MONTH
                PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING [OR] [$Amount].
                ...
                RIGHTS.] INDEMNIFICATION You agree to defend, indemnify, and
                hold us harmless, including our subsidiaries, affiliates, and
                all of our respective officers, agents, partners, and employees,
                ...
                means. MISCELLANEOUS These Terms of Use and any policies or
                operating rules posted by us on the Application constitute the
                ...
                of Use. CONTACT US In order to resolve a complaint regarding the
                Application or to receive further information regarding use of
                the Application, please contact us at: GeoPicK Dubai, UAE
                04-0404040 geopick2021@gmail.com
              </Typography>
            </ThemeProvider>
          </DialogContentText>
        </DialogContent>
