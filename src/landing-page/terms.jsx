...
import { Link, createMuiTheme, ThemeProvider } from "@material-ui/core";
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            ...
            of an entity (“you”) and GeoPicK (“we,” “us” or “our”), concerning
            ...
            APPLICATION AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental
            ...
            updating the “Last updated” date of these Terms and Conditions and
            ...
            the Application after the date such revised Terms are posted. The
            information provided on the Application is not intended for
            distribution to or use by any person or entity in any jurisdiction
            or country where such distribution or use would be contrary to law
            or regulation or which would subject us to any registration
            requirement within such jurisdiction or country. Accordingly, those
            persons who choose to access the Application from other locations do
            ...
            Conditions Generator. The Application is intended for users who are
            at least 13 years of age. All users who are minors in the
            ...
            parent or guardian to use the Application. If you are a minor, you
            must have your parent or guardian read and agree to these Terms of
            Use prior to you using the Application. INTELLECTUAL PROPERTY RIGHTS
            ...
            rights and unfair competition laws of the United Arab Emirates,
            ...
            permission. Provided that you are eligible to use the Application,
            you are granted a limited license to access and use the Application
            ...
            you in and to the Application, Content, and the Marks. USER
            REPRESENTATIONS By using the Application, you represent and warrant
            ...
            agree to comply with these Terms of Use; (4) you are not under the
            age of 13; (5) not a minor in the jurisdiction in which you reside,
            or if a minor, you have received parental permission to use the
            Site; (6) you will not access the Application through automated or
            non-human means, whether through a bot, script or otherwise; (7) you
            will not use the Application for any illegal or unauthorized
            purpose; and (8) your use of the Application will not violate any
            ...
            future use of the Application(or any portion thereof). USER
            REGISTRATION You may be required to register with the Application.
            ...
            or use the Application for any purpose other than that for which we
            make the Application available. The Application may not be used in
            connection with any commercial endeavors except those that are
            specifically endorsed or approved by us. As a user of the
            Application, you agree not to: Systematically retrieve data or other
            content from the Application to create or compile, directly or
            ...
            Application, including collecting usernames and/or email addresses
            ...
            under false pretenses. Use a buying agent or purchasing agent to
            make purchases on the Application. Use the Application to advertise
            or offer to sell goods and services. Circumvent, disable, or
            otherwise interfere with security-related features of the
            Application, including features that prevent or restrict the use or
            ...
            learn sensitive account information such as user passwords; Make
            improper use of our support services or submit false reports of
            abuse or misconduct. Engage in any automated use of the system, such
            ...
            profile. Use any information obtained from the Application in order
            to harass, abuse, or harm another person. Use the Application as
            part of any effort to compete with us or otherwise use the
            Application and/or the Content for any revenue-generating endeavor
            or commercial enterprise. Decipher, decompile, disassemble, or
            reverse engineer any of the software comprising or in any way making
            up a part of the Application. Attempt to bypass any measures of the
            Application designed to prevent or restrict access to the
            Application, or any portion of the Application. Harass, annoy,
            intimidate, or threaten any of our employees or agents engaged in
            providing any portion of the Application to you. Delete the
            ...
            Flash, PHP, HTML, JavaScript, or other code. Upload or transmit (or
            ...
            party’s uninterrupted use and enjoyment of the Application or
            modifies, impairs, disrupts, alters, or interferes with the use,
            features, functions, operation, or maintenance of the Application.
            ...
            offline reader that accesses the Application, or using or launching
            any unauthorized script or other software. Disparage, tarnish, or
            otherwise harm, in our opinion, us and/or the Application. Use the
            Application in a manner inconsistent with any applicable laws or
            regulations. USER GENERATED CONTRIBUTIONS The Application may invite
            you to chat, contribute to, or participate in blogs, message boards,
            online forums, play games and other functionality, and may provide
            ...
            us or on the Application, including but not limited to text,
            writings, video, audio, photographs, graphics, comments,
            suggestions, or personal information or other material
            (collectively, “Contributions”). Contributions may be viewable by
            other users of the Application and through third-party websites. As
            ...
            and permissions to use and to authorize us, the Application, and
            other users of the Application to use your Contributions in any
            manner contemplated by the Application and these Terms of Use. You
            ...
            manner contemplated by the Application and these Terms of Use. Your
            Contributions do not include images of person(s) Your Contributions
            ...
            another. Your Contributions do not violate any applicable law,
            ...
            under the age of 18 or exploits people under the age of 18 in a
            sexual or violent manner. Your Contributions do not violate any
            ...
            or any applicable law or regulation. Any use of the Application in
            ...
            rights to use the Application. CONTRIBUTION LICENSE By posting your
            Contributions to any part of the Application, or making
            ...
            provided by you in any area on the Application. You are solely
            ...
            in more appropriate locations on the Application; and (3) to
            ...
            the Application to leave reviews or ratings. When posting a review,
            ...
            reviews; (6) you should not make any conclusions as to the legality
            of conduct; (7) you may not post any false or misleading statements;
            and (8) you may not organize a campaign encouraging others to post
            reviews, whether positive or negative. We may accept, reject, or
            remove reviews in our sole discretion. We have absolutely no
            ...
            views of any of our affiliates or partners. We do not assume
            ...
            LICENSE Use License If you access the Application via a mobile
            ...
            SOCIAL MEDIA As part of the functionality of the Application, you
            may link your account with online accounts you have with third-party
            ...
            through the Application via your account, including without
            ...
            your account on the Application. Please note that if a Third-Party
            ...
            and through the Application. You will have the ability to disable
            the connection between your account on the Application and your
            ...
            Application. You can deactivate the connection between the
            Application and your Third-Party Account by contacting us using the
            ...
            account. SUBMISSIONS You acknowledge and agree that any questions,
            comments, suggestions, ideas, feedback, or other information
            regarding the Application (“Submissions”) provided by you to us are
            ...
            THIRD-PARTY WEBSITES AND CONTENT The Application may contain (or you
            may be sent via the Application) links to other websites
            ...
            accessed through the Application or any Third-Party Content posted
            on, available through, or installed from the Application, including
            ...
            Websites. ADVERTISERS We allow advertisers to display their
            advertisements and other information in certain areas of the
            Application, such as sidebar advertisements or banner
            advertisements. If you are an advertiser, you shall take full
            responsibility for any advertisements you place on the Application
            and any services provided on the Application or products sold
            ...
            advertisements on the Application, including, but not limited to,
            ...
            APP MANAGEMENT We reserve the right, but not the obligation, to: (1)
            monitor the Application for violations of these Terms of Use; (2)
            ...
            limitation, notice, or liability, to remove from the Application or
            ...
            manage the Application in a manner designed to protect our rights
            and property and to facilitate the proper functioning of the
            Application. PRIVACY POLICY We care about data privacy and security.
            Please review our Privacy Policy. By using the Application, you
            agree to be bound by our Privacy Policy, which is incorporated into
            these Terms of Use. Please be advised the Application is hosted in
            the United Arab Emirates. If you access the Application from the
            European Union, Americas, or any other region of the world with laws
            ...
            then through your continued use of the Application or Services, you
            are transferring your data to the United Arab Emirates, and you
            expressly consent to have your data transferred to and processed in
            the United Arab Emirates. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA)
            NOTICE AND POLICY Notifications We respect the intellectual property
            rights of others. If you believe that any material available on or
            through the Application infringes upon any copyright you own or
            control, please immediately notify our Designated Copyright Agent
            ...
            is allegedly infringed; (2) identification of the copyrighted work
            claimed to have been infringed, or, if multiple copyrighted works on
            the Application are covered by the Notification, a representative
            list of such works on the Application; (3) identification of the
            ...
            has been removed from the Application as a result of a mistake or
            ...
            provided below (a “Counter Notification”). To be an effective
            Counter Notification under the DMCA, your Counter Notification must
            ...
            is outside the United Arab Emirates, for any judicial district in
            which we are located; (3) a statement that you will accept service
            of process from the party that filed the Notification or the party’s
            ...
            material in question was removed or disabled as a result of a
            mistake or misidentification of the material to be removed or
            disabled; and (6) your physical or electronic signature. If you send
            us a valid, written Counter Notification meeting the requirements
            described above, we will restore your removed or disabled material,
            unless we first receive notice from the party filing the
            Notification informing us that such party has filed a court action
            ...
            mistake or misidentification, you may be liable for damages,
            including costs and attorney’s fees. Filing a false Counter
            Notification constitutes perjury. Designated Copyright Agent XYZ
            Attn: Copyright Agent 1234, ABC Street Dubai xyz@abccopyright.com
            COPYRIGHT INFRINGEMENTS We respect the intellectual property rights
            of others. If you believe that any material available on or through
            ...
            on or linked to by the Application infringes your copyright, you
            should consider first contacting an attorney. TERM AND TERMINATION
            ...
            modify, or remove the contents of the Application at any time or for
            any reason at our sole discretion without notice. However, we have
            no obligation to update any information on our Application. We also
            reserve the right to modify or discontinue all or part of the
            Application without notice at any time. We will not be liable to you
            or any third party for any modification, price change, suspension,
            or discontinuance of the Application. We cannot guarantee the
            ...
            related to the Application, resulting in interruptions, delays, or
            errors. We reserve the right to change, revise, update, suspend,
            discontinue, or otherwise modify the Application at any time or for
            ...
            by your inability to access or use the Application during any
            downtime or discontinuance of the Application. Nothing in these
            Terms of Use will be construed to obligate us to maintain and
            support the Application or to supply any corrections, updates, or
            releases in connection therewith. GOVERNING LAW These Terms of Use
            and your use of the Application are governed by and construed in
            accordance with the laws of the State of [name of state] applicable
            to agreements made and to be entirely performed within the
            State/Commonwealth of [name of state], without regard to its
            conflict of law principles. DISPUTE RESOLUTION To expedite
            resolution and control the cost of any dispute, controversy, or
            claim related to these Terms of Use (each a “Dispute” and
            ...
            of years] days before initiating arbitration. Such informal
            ...
            [name of county] County, [name of state]. Except as otherwise
            ...
            the state and federal courts located in [name of county] County,
            [name of state], and the Parties hereby consent to, and waive all
            defenses of lack of personal jurisdiction, and forum non convenient
            ...
            for the International Sale of Goods and the the Uniform Computer
            Information Transaction Act (UCITA) are excluded from these Terms of
            Use. In no event shall any Dispute brought by either Party related
            in any way to the Application be commenced more than [# of years]
            ...
            the personal jurisdiction of that court. CORRECTIONS There may be
            information on the Application that contains typographical errors,
            inaccuracies, or omissions that may relate to the Application,
            ...
            on the Application at any time, without prior notice. DISCLAIMER THE
            ...
            WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE APPLICATION
            ...
            ACCESS TO AND USE OF THE APPLICATION, (3) ANY UNAUTHORIZED ACCESS TO
            ...
            THE APPLICATION, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE
            ...
            EXERCISE CAUTION WHERE APPROPRIATE. LIMITATIONS OF LIABILITY IN NO
            ...
            TO US DURING THE [# of months] MONTH PERIOD PRIOR TO ANY CAUSE OF
            ACTION ARISING [OR] [$Amount]. CERTAIN STATE LAWS DO NOT ALLOW
            ...
            HAVE ADDITIONAL RIGHTS.] INDEMNIFICATION You agree to defend,
            ...
            indemnification upon becoming aware of it. USER DATA We will
            maintain certain data that you transmit to the Site for the purpose
            of managing the Site, as well as data relating to your use of the
            ...
            arising from any such loss or corruption of such data. ELECTRONIC
            COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the Site,
            ...
            MISCELLANEOUS These Terms of Use and any policies or operating rules
            posted by us on the Application constitute the entire agreement and
            ...
            parties hereto to execute these Terms of Use. CONTACT US In order to
            resolve a complaint regarding the Application or to receive further
            information regarding use of the Application, please contact us at:
            GeoPicK Dubai, UAE 04-0404040 geopick2021@gmail.com
          </DialogContentText>
        </DialogContent>
        <DialogActions>
